      ...
      <Card style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Y智能AI 是一个整合了 umi，Y智能AI 和 ProComponents
          ...
          <div style={{
            ...
            <InfoCard index={2} title="了解 Y智能AI" href="https://ant.design" desc="antd 是基于 Y智能AI 设计体系的 React UI 组件库，主要用于研发企业级中后台产品。"/>
            <InfoCard index={3} title="了解 Pro Components" href="https://procomponents.ant.design" desc="ProComponents 是一个基于 Y智能AI 做了更高抽象的模板组件，以 一个组件就是一个页面为开发理念，为中后台开发带来更好的体验。"/>
          </div>
        </div>
      </Card>
    </PageContainer>);
